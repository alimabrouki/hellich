...
function HeroTitle ({ animate }: animate) {
  return (
    <h1
      dir='rtl'
      className='hero-img text-[clamp(4.4rem,19vw,7.9rem)] max-[479px]:text-[60px] sm:text-[clamp(4.8rem,12.2vw,11.8rem)] text-second-bg font-extrabold text-right tracking-tight'
    >
      <span
