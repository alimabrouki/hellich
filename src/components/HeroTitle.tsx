...
function HeroTitle({ animate }: animate) {
  return (
    <h1
      dir="rtl"
      className="hero-title text-[clamp(4.4rem,19vw,7.9rem)] max-w-[1440px]  lg:text-[clamp(5.8rem,7.2vw,6.8rem)] max-[479px]:text-[60px] lg:text-center w-full sm:text-[clamp(6.8rem,12.2vw,11.8rem)] text-surface-muted font-extrabold text-right tracking-tight"
    >
      <span
