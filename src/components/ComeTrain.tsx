...
import trainer1 from "../assets/images/train-client1.webp";
import trainer4 from "../assets/images/train-client2.webp";
import trainer3 from "../assets/images/train-client3.webp";
import trainer2 from "../assets/images/train-client4.webp";
import trainer5 from "../assets/images/train-client5.webp";
...
function ComeTrain() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const rect = section.getBoundingClientRect();
      const vh = window.innerHeight || 1;
      const viewport30 = vh * 0.7;
      const isAt30 = rect.top < viewport30;
      ...
      if (isScrolling) {
        ...
        isInViewport = rect.top < vh && rect.bottom > sectionEnd;

        if (isInViewport && timeSinceScroll > 100) {
          const autoSpeed = 0.15;
          currentShift += shiftDirection * autoSpeed;
