...
const certifiedSubtitle =
  "أنا محمد مبروكي (hellich)، مدرب لياقة و كمال أجسام متخصص مكرّس لمساعدة الناس على تحويل أجسامهم ونمط حياتهم، بمزيج من تدريب القوة وإرشاد التغذية والتحفيز، أجعل اللياقة بسيطة وفعالة ومستدامة.";
  ...
  useEffect(() => {
    ...
    if ("IntersectionObserver" in window) {
      const observer = new IntersectionObserver(
        ...
        { threshold: 0.3, rootMargin: "30% 0px 0px 0px" },
      );
        ...
        <div className="who-am-i-content">
          ...
          >
            ...
            <div className="who-am-i-image-main-wrap">
              ...
              />
              <span
                className="who-am-i-image-main-overlay"
                aria-hidden="true"
              />
            </div>
          </div>
...
export default memo(WhoAmISection);
